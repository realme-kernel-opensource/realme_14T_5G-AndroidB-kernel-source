...
#include "../mediatek/mediatek_v2/mtk_corner_pattern/ae152_p_d_a0031_hd_data_hw_roundedpattern.h"
#endif
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xD6, 0x00);
        jdi_dcs_write_seq_static(ctx, 0xB6, 0x30, 0x6c, 0x00, 0x86, 0xc3, 0x03);

	jdi_dcs_write_seq_static(ctx, 0xC0, 0x00, 0x40, 0x1f, 0x06, 0x22, 0x00, 0x06, 0x06, 0x94, 0x00, 0x70, 0x00, 0x00,
	...
	jdi_dcs_write_seq_static(ctx, 0xEB, 0x09, 0xF0, 0x9F, 0x00, 0x01, 0x01, 0x00, 0x00);
        jdi_dcs_write_seq_static(ctx, 0xEC, 0x02, 0xd0, 0x02, 0x70, 0x73, 0x10, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0x2a,
...
#define VAC (1570)
#define HAC (720)
#define VFP_45hz (3150)
#define VFP_60hz (1958)
#define VFP_90hz (772)
#define VFP_120hz (180)
#define VFP_144hz (140)
#define DYN_PLL_CLK (614)
#define DYN_DATA_RATE (1228)
#define HFP_DYN (200)
#define HFP_DYN_144hz (58)
