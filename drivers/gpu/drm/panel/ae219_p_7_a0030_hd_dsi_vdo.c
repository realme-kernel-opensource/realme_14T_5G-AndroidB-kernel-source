 ...
 ** OPLUS_EDIT
 ** File: ae219_p_7_a0030_hd_dsi_vdo.c
...
#endif
#include "ae219_p_7_a0030_hd_dsi_vdo.h"
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0x1B, 0x10);
	...
	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x12);
	jdi_dcs_write_seq_static(ctx, 0x01, 0x38);
	jdi_dcs_write_seq_static(ctx, 0x02, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x10, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x11, 0x6C);
	jdi_dcs_write_seq_static(ctx, 0x12, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x13, 0x18);
	jdi_dcs_write_seq_static(ctx, 0x14, 0x01);
	jdi_dcs_write_seq_static(ctx, 0x15, 0x72);
	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x0B);
	jdi_dcs_write_seq_static(ctx, 0xAD, 0x47);
	jdi_dcs_write_seq_static(ctx, 0xAE, 0x12);
	jdi_dcs_write_seq_static(ctx, 0xAF, 0x05);
	jdi_dcs_write_seq_static(ctx, 0xB0, 0x05);
	jdi_dcs_write_seq_static(ctx, 0xB1, 0xB0);
	jdi_dcs_write_seq_static(ctx, 0xB2, 0xB0);
	jdi_dcs_write_seq_static(ctx, 0xBD, 0x22);
	jdi_dcs_write_seq_static(ctx, 0xBE, 0xE0);
	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x0E);
	jdi_dcs_write_seq_static(ctx, 0x18, 0x17);
	jdi_dcs_write_seq_static(ctx, 0x19, 0x09);
	...
	jdi_dcs_write_seq_static(ctx, 0x68, 0x03, 0x00);
...
#define VAC (1570)
#define HAC (720)
#define VFP_45hz (4580)
#define VFP_60hz (3110)
#define VFP_90hz (1546)
#define VFP_120hz (760)
#define VFP_144hz (370)
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
        ...
        pr_info("%s+ jdi_probe enter p_7_a0030, vdo,120hz\n", __func__);
	...
	register_device_proc("lcd", "A0030", "P_7");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "ae219,p_7,a0030,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "ae219_p_7_a0030_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("AE219 P_7 A0030 VDO 120HZ LCD Panel Driver");
