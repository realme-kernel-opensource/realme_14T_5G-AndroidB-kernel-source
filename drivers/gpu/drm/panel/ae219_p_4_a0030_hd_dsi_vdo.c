 ...
 ** OPLUS_EDIT
 ** File: ae219_p_4_a0030_hd_dsi_vdo.c
...
#endif
#include "ae219_p_4_a0030_hd_dsi_vdo.h"
...
#define MAX_NORMAL_BRIGHTNESS   3285
#define LOW_BACKLIGHT_LEVEL     7
...
#define MIPI_DRIVER_VOLTAGE   0x7
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0x3E, 0x62);

	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x02);
	jdi_dcs_write_seq_static(ctx, 0x06, 0x38);
	jdi_dcs_write_seq_static(ctx, 0x3A, 0x6C);
	jdi_dcs_write_seq_static(ctx, 0x3E, 0x66);
	...
	jdi_dcs_write_seq_static(ctx, 0xBB, 0xBC);
	...
	jdi_dcs_write_seq_static(ctx, 0xA9, 0xFF);
	jdi_dcs_write_seq_static(ctx, 0xAC, 0xFF);
	jdi_dcs_write_seq_static(ctx, 0xB3, 0xFF);

	jdi_dcs_write_seq_static(ctx, 0x8C, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x8D, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x8E, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x8F, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x90, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x91, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x92, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x93, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x94, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x95, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0xA7, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0xAA, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0xAD, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0xB4, 0xEB);

	jdi_dcs_write_seq_static(ctx, 0xA8, 0xF0);
	jdi_dcs_write_seq_static(ctx, 0xAE, 0xD5);
	jdi_dcs_write_seq_static(ctx, 0x96, 0x60);
	jdi_dcs_write_seq_static(ctx, 0x97, 0x9B);
	jdi_dcs_write_seq_static(ctx, 0x98, 0xB2);
	jdi_dcs_write_seq_static(ctx, 0x99, 0xB5);
	jdi_dcs_write_seq_static(ctx, 0x9A, 0xC6);
	jdi_dcs_write_seq_static(ctx, 0x9B, 0xD5);
	jdi_dcs_write_seq_static(ctx, 0x9C, 0xD5);
	jdi_dcs_write_seq_static(ctx, 0x9D, 0xD1);
	jdi_dcs_write_seq_static(ctx, 0x9E, 0xC0);
	jdi_dcs_write_seq_static(ctx, 0x9F, 0xD5);
	...
	jdi_dcs_write_seq_static(ctx, 0xC6, 0x50);
	jdi_dcs_write_seq_static(ctx, 0xFB, 0xC1);

	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x06);
	jdi_dcs_write_seq_static(ctx, 0x07, 0xA4);

	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x0B);
	jdi_dcs_write_seq_static(ctx, 0xA6, 0x47);
	jdi_dcs_write_seq_static(ctx, 0xA7, 0x1C);
	jdi_dcs_write_seq_static(ctx, 0xA8, 0x05);
	jdi_dcs_write_seq_static(ctx, 0xA9, 0x05);
	jdi_dcs_write_seq_static(ctx, 0xAA, 0xB1);
	jdi_dcs_write_seq_static(ctx, 0xAB, 0xB1);

	jdi_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x0E);
	jdi_dcs_write_seq_static(ctx, 0x14, 0x17);
	jdi_dcs_write_seq_static(ctx, 0x15, 0x08);
...
#define VAC (1570)
#define HAC (720)
#define VFP_45hz (4640)
#define VFP_60hz (3090)
#define VFP_90hz (1528)
#define VFP_120hz (748)
#define VFP_144hz (358)
#define DYN_PLL_CLK (650)
#define DYN_DATA_RATE (1300)
#define HFP_DYN (24)
#define PLL_CLOCK (645)
#define DATA_RATE (1290)
...
static const struct drm_display_mode performance_mode_144hz = {
        .clock = ((HAC + HFP + HSA + HBP) * (VAC + VFP_144hz + VSA + VBP) * 144) / 1000,
        .hdisplay = HAC,
        .hsync_start = HAC + HFP,
        .hsync_end = HAC + HFP + HSA,
        .htotal = HAC + HFP + HSA + HBP,
...
static int backlight_exp[4096] = {0};

static void init_global_exp_backlight(void)
{
	int lut_index[41] = {0, 4, 99, 144, 187, 227, 264, 300, 334, 366, 397, 427, 456, 484, 511, 537, 563, 587, 611, 635, 658,
		680, 702, 723, 744, 764, 784, 804, 823, 842, 861, 879, 897, 915, 933, 950, 967, 984, 1000, 1016, 1023};
	int lut_value1[41] = {0, 4, 7, 14, 24, 37, 52, 69, 87, 107, 128, 150, 173, 197, 222, 248, 275, 302, 330, 358, 387, 416,
		446, 479, 509, 541, 572, 604, 636, 669, 702, 735, 769, 803, 837, 871, 905, 938, 973, 1008, 1023};
	...
	if (index_len == value_len) {
		for (i = 0; i < index_len - 1; i++) {
			index_start = lut_index[i] * 3069 / 1023;
			index_end = lut_index[i+1] * 3069 / 1023;
			value1_start = lut_value1[i] * 3069 / 1023;
			value1_end = lut_value1[i+1] * 3069 / 1023;
			for (j = index_start; j <= index_end; j++) {
				backlight_exp[j] = value1_start + (value1_end - value1_start) * (j - index_start) / (index_end - index_start);
			}
		}
	}
	j = 0;
	/* type 21ma, DBV 2857, bringhtness 2972 */
	/* hbm 27ma,  DBV 3668, bringhtness 3783-4095 */
	/* sales_mode 23ma, DBV 3128, bringhtness 3243 */
	for (i = 2972; i < 4096; i++) {
		backlight_exp[i] = 2857 + j;
		j++;
		if (i > 3783)
			backlight_exp[i] = 3668;
	}

	/* new map type 21ma, DBV 2857, bringhtness 3285 */
	/* new map hbm 27ma,  DBV 3668, bringhtness 4095 */
	/* new map sales_mode 23ma, DBV 3128, bringhtness 3555 */
	for (j = 1; j <= ud_level; j++) {
		map_exp[j] = ud_51;
	}
	i = 11;
	for (j = ud_level + 1; j < 4096; j++) {
		map_exp[j] = backlight_exp[i];
		i++;
	}
}
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "ae219,p_4,a0030,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "ae219_p_4_a0030_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("AE219 P_4 A0030 VDO 120HZ LCD Panel Driver");
