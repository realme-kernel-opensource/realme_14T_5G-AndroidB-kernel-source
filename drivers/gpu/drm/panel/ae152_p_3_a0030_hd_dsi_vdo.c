...
#include "../mediatek/mediatek_v2/mtk_corner_pattern/ae152_p_3_a0030_hd_data_hw_roundedpattern.h"
#endif
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0x9D, 0xD5);
	jdi_dcs_write_seq_static(ctx, 0x9E, 0xD5);
