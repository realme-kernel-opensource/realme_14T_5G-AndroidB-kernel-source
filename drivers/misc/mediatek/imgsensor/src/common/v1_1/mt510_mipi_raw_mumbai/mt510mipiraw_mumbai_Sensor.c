...
#include "mt510mipiraw_mumbai_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = MT510_SENSOR_ID_MUMBAI,
    .checksum_value = 0xbe0a4dd5,
    .pre = {
        .pclk = 88800000,
        .linelength = 1458,
        .framelength = 2030,
        .mipi_pixel_rate = 178000000,
        .startx = 0,
        .starty = 0,
...
static  struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
    ...
    {2592, 1944, 16, 252, 2560, 1440, 1280, 720, 0, 0, 1280, 720, 0, 0, 1280, 720}, // video
    {2592, 1944, 16, 252, 2560, 1440, 1280, 720, 0, 0, 1280, 720, 0, 0, 1280, 720},// hight speed video
...
kal_uint16 addr_data_pair_init_mt510[] = {
    0x0d00, 0x00,
    0x0d01, 0x00,
    0x0d02, 0x82,
    0x0d03, 0x32,
...
static void sensor_init(void)
{
    ...
    mt510_table_write_cmos_sensor(addr_data_pair_init_mt510,
        sizeof(addr_data_pair_init_mt510)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_mt510[] = {
    0x0534, 0x3a,
    0x0535, 0x01,
    0x0536, 0x74,
    0x0537, 0x01,
...
static void preview_setting(void)
{
    ...
    mt510_table_write_cmos_sensor(addr_data_pair_preview_mt510,
        sizeof(addr_data_pair_preview_mt510)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_capture_mt510[] = {
    0x0534, 0x3a,
    0x0535, 0x01,
    0x0536, 0x74,
    0x0537, 0x01,
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    mt510_table_write_cmos_sensor(addr_data_pair_capture_mt510,
        sizeof(addr_data_pair_capture_mt510)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_normal_video_mt510[] = {
    0x0534, 0x3a,
    0x0535, 0x01,
    0x0536, 0x74,
    0x0537, 0x01,
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    mt510_table_write_cmos_sensor(addr_data_pair_normal_video_mt510,
        sizeof(addr_data_pair_normal_video_mt510)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_mt510[] = {
    0x0534, 0x3a,
    0x0535, 0x01,
    0x0536, 0x74,
    0x0537, 0x01,
...
static void hs_video_setting(void)
{
    ...
    mt510_table_write_cmos_sensor(addr_data_pair_hs_video_mt510,
        sizeof(addr_data_pair_hs_video_mt510)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_silm_video_mt510[] = {
    0x0534, 0x3a,
    0x0535, 0x01,
    0x0536, 0x74,
    0x0537, 0x01,
...
static void slim_video_setting(void)
{
    ...
    mt510_table_write_cmos_sensor(addr_data_pair_silm_video_mt510,
        sizeof(addr_data_pair_silm_video_mt510)/sizeof(kal_uint16));
}
...
static int read_otp_group_flag()
{
	u32 read_addr = 0;
...
UINT32 MT510_MIPI_RAW_MUMBAI_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
