...
#include "imx852mipiraw_chopard_Sensor.h"
			...
			if (*sensor_id == (IMX852_SENSOR_ID_CHOPARD - 1)) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				if(first_read){
					...
					read_imx852_chopard_QSC(imx852_QSC_setting);
...
UINT32 IMX852_MIPI_RAW_CHOPARD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
