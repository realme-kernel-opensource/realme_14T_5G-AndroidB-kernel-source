...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
    ...
    {
        SENSOR_DRVNAME_GC50F6_MIPI_RAW_CRUISERL5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  3},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV08F10_MIPI_RAW_CRUISERL5)
    {
        SENSOR_DRVNAME_OV08F10_MIPI_RAW_CRUISERL5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(SC202CS_MIPI_RAW_CRUISERL5)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_CRUISERL5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(IMX852_MIPI_RAW_CHOPARD)
    {
       SENSOR_DRVNAME_IMX852_MIPI_RAW_CHOPARD,
        {
              {RST, Vol_Low, 1},
              {DOVDD, Vol_1800, 1},
              {AVDD, Vol_2900, 2},
...
#endif
#if defined(GC50F6_MIPI_RAW_MUMBAID)
    {
        SENSOR_DRVNAME_GC50F6_MIPI_RAW_MUMBAID,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(MT510_MIPI_RAW_MUMBAID)
    {
        SENSOR_DRVNAME_MT510_MIPI_RAW_MUMBAID,
        {
            {SensorMCLK, Vol_High, 0},
            {DVDD, Vol_1200, 1},
            {DOVDD, Vol_1800, 0},
...
#endif
#if defined(OV13B10_MIPI_RAW_MUMBAI)
    {
        SENSOR_DRVNAME_OV13B10_MIPI_RAW_MUMBAI,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(MT510_MIPI_RAW_MUMBAI)
    {
        SENSOR_DRVNAME_MT510_MIPI_RAW_MUMBAI,
        {
            {SensorMCLK, Vol_High, 0},
            {DVDD, Vol_1200, 1},
            {DOVDD, Vol_1800, 0},
